...
extension CVCalendarView {
    public func didSelectDayView(_ dayView: CVCalendarDayView) {
        ...
        print ("Present Date \(dayView.date.commonDescription)")
        print ("Present Date \(String(describing: dayView.date.convertedDate()))")
        print ("Present Date \(dayView.date.globalDescription)")
        print ("Present Day \(String(describing: dayView.date.weekDay()))")
